...
/***/ function(module, exports, __webpack_require__) {
	...
	var _actionsSubscriptions = __webpack_require__(254);
	...
	var SearchLine = (function (_React$Component5) {
	  ...
	  function SearchLine() {
	    ...
	    _get(Object.getPrototypeOf(SearchLine.prototype), 'constructor', this).apply(this, arguments);
	  }
	
	  _createClass(SearchLine, [{
	    key: 'changePattern',
	    value: function changePattern() {
	      var pattern = this.refs.pattern.value.trim().toLowerCase();
	    ...
	    value: function render() {
	      ...
	      var activeFilter = _props2.activeFilter;
	      ...
	      return _react2['default'].createElement(
	        ...
	        _react2['default'].createElement(
	          'div',
	          { className: 'filter__subscription' },
	          _react2['default'].createElement(
	            'span',
	            { className: activeFilter === _actions.VisibilityFilters.SHOW_SUBSCRIBED ? 'filter__subscription_active' : '', onClick: function () {
	                return _this.props.setVisibilityFilter(_actions.VisibilityFilters.SHOW_SUBSCRIBED);
	              } },
	            'Подписки'
	          ),
	          _react2['default'].createElement(
	            'span',
	            { className: activeFilter === _actions.VisibilityFilters.SHOW_ALL ? 'filter__subscription_active' : '', onClick: function () {
	                return _this.props.setVisibilityFilter(_actions.VisibilityFilters.SHOW_ALL);
	              } },
	            'Все'
	          ),
	          _react2['default'].createElement(
	            'span',
	            { className: activeFilter === _actions.VisibilityFilters.SHOW_UNSUBSCRIBED ? 'filter__subscription_active' : '', onClick: function () {
	                return _this.props.setVisibilityFilter(_actions.VisibilityFilters.SHOW_UNSUBSCRIBED);
	              } },
	            'Неподписки'
	          )
	        ),
	        _react2['default'].createElement('input', { className: 'filter__search_line', type: 'text', ref: 'pattern', placeholder: 'Поиск по названию', onChange: function () {
	            return _this.changePattern();
	          } })
	      );
	    }
	  }]);
	...
	var Tokens = (function (_React$Component6) {
	  ...
	  function Tokens() {
	    ...
	    _get(Object.getPrototypeOf(Tokens.prototype), 'constructor', this).apply(this, arguments);
	  }
	  ...
	  _createClass(Tokens, [{
	    ...
	    value: function render() {
	      ...
	      var subscribe = _props3.subscribe;
	      var unsubscribe = _props3.unsubscribe;
	
	      var godFilter = function godFilter(token) {
	        return token.serial.title.toLowerCase().indexOf(pattern) + 1 || token.studio.name.toLowerCase().indexOf(pattern) + 1;
	      };
	
	      var filteredTokens = tokens.filter(godFilter);
	
	      if (filter !== _actions.VisibilityFilters.SHOW_ALL && filter === _actions.VisibilityFilters.SHOW_SUBSCRIBED) {
	        filteredTokens = filteredTokens.filter(function (token) {
	          return token.subscribed === true;
	        });
	      }
	
	      if (filter !== _actions.VisibilityFilters.SHOW_ALL && filter === _actions.VisibilityFilters.SHOW_UNSUBSCRIBED) {
	        filteredTokens = filteredTokens.filter(function (token) {
	          return token.subscribed === false;
	        });
	      }
	      ...
	      return _react2['default'].createElement(
	        'div',
	        null,
	        filteredTokens.length > 0 ? filteredTokens.map(function (token) {
	          return _react2['default'].createElement(Token, { token: token, pattern: pattern, subscribe: subscribe, unsubscribe: unsubscribe });
	        }) : _react2['default'].createElement(
	          'div',
	          { className: 'f5_message' },
	          'F5. Должно помочь.'
	        )
	      );
	    }
	  ...
	  _createClass(Token, [{
	    ...
	    value: function renderButton() {
	      ...
	      if (this.props.token.subscribed) {
	        return _react2['default'].createElement(
	          'button',
	          { className: 'token__button token__button_unsubscribe', onClick: function () {
	              return _this2.props.unsubscribe(_this2.props.token.id);
	            } },
	          'Отписаться'
	        );
	      }
	      return _react2['default'].createElement(
	        'button',
	        { className: 'token__button token__button_subscribe', onClick: function () {
	            return _this2.props.subscribe(_this2.props.token.id);
	          } },
	        'Подписаться'
	      );
	    }
	    ...
	    value: function backgroundPattern(str, pattern) {
	    ...
	    value: function render() {
	      ...
	      return _react2['default'].createElement(
	        ...
	        _react2['default'].createElement(
	          ...
	          _react2['default'].createElement(
	            'a',
	            { href: 'https://yandex.ru/search/?text=' + encodeURI(token.serial.title + ' сериал'), target: '_blank' },
	            this.backgroundPattern(token.serial.title, pattern)
	          )
	        ),
	        _react2['default'].createElement(
	          'div',
	          { className: 'token__studio' },
	...
	_reactDom2['default'].render(_react2['default'].createElement(Root, null), document.getElementById('react-app'));
	
	var wow = function wow() {
	  return _reactDom2['default'].render(_react2['default'].createElement(Root, null), document.getElementById('react-app'));
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _componentsProvider = __webpack_require__(156);
	
	exports.Provider = _interopRequire(_componentsProvider);
	
	var _componentsConnect = __webpack_require__(158);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _utilsStoreShape = __webpack_require__(157);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _utilsShallowEqual = __webpack_require__(159);
	...
	var _utilsWrapActionCreators = __webpack_require__(161);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _actionsEpisodesActions = __webpack_require__(252);
	
	var _apiWebsocket = __webpack_require__(262);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _actionCreators = __webpack_require__(234);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _routerStateEquals = __webpack_require__(230);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reduxReactRouter = __webpack_require__(236);
	
	var _reduxReactRouter2 = _interopRequireDefault(_reduxReactRouter);
	
	var _useDefaults = __webpack_require__(238);
	
	var _useDefaults2 = _interopRequireDefault(_useDefaults);
	
	var _routeReplacement = __webpack_require__(239);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _historyMiddleware = __webpack_require__(237);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _replaceRoutesMiddleware = __webpack_require__(240);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reactRouterLibIsActive = __webpack_require__(214);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _useBeforeUnload2 = __webpack_require__(244);
	...
	var _enableBeforeUnload2 = __webpack_require__(245);
	
	var _enableBeforeUnload3 = _interopRequireDefault(_enableBeforeUnload2);
	
	exports.enableBeforeUnload = _enableBeforeUnload3['default'];
	
	var _enableQueries2 = __webpack_require__(246);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _useBeforeUnload = __webpack_require__(244);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _subscriptions = __webpack_require__(260);
	...
	function visibilityFilter(state, action) {
	  ...
	  switch (action.type) {
	    ...
	    case _actions.SET_PATTERN:
	      return _extends({}, state, { pattern: action.pattern });
	    default:
	      return state;
	  }
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	function auth(state, action) {
	  ...
	  switch (type) {
	    case _actionsAuthActions.AUTH_LOGIN:
	      if (!status) {
	        return _extends({}, DEFAULT_STATE, { isLoading: true });
	      }
	
	    case _actionsAuthActions.AUTH_PROFILE:
	      if (!status) {
	        return _extends({}, state, { isLoading: true });
	      }
	
	      if (status === 'success') {
	        return _extends({}, state, { profile: profile, isLoading: false, didInvalidate: false, error: null });
	      } else {
	        return _extends({}, DEFAULT_STATE, { error: error, isLoading: false, didInvalidate: false });
	      }
	
	    case _actionsAuthActions.AUTH_REGISTER:
	      if (!status) {
	        return _extends({}, state, { isLoading: true });
	      }
	
	      if (status === 'success') {
	        return _extends({}, state, { message: message, error: null });
	      } else {
	        return _extends({}, state, { error: error });
	      }
	
	    case _actionsAuthActions.INVALIDATE_PROFILE:
	      return _extends({}, state, { didInvalidate: true });
	
	    case _actionsAuthActions.AUTH_LOGOUT:
	      return state;
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.authRegisterSuccess = authRegisterSuccess;
	exports.authRegisterFailure = authRegisterFailure;
	exports.authLoginRequest = authLoginRequest;
	exports.authLoginSuccess = authLoginSuccess;
	exports.authLoginFailure = authLoginFailure;
	exports.authLogoutRequest = authLogoutRequest;
	...
	var _apiAuth = __webpack_require__(251);
	...
	var _episodesActions = __webpack_require__(252);
	
	var _subscriptions = __webpack_require__(254);
	
	/*
	 * action types
	 */
	
	var INVALIDATE_PROFILE = 'INVALIDATE_PROFILE';
	exports.INVALIDATE_PROFILE = INVALIDATE_PROFILE;
	var AUTH_PROFILE = 'AUTH_PROFILE';
	exports.AUTH_PROFILE = AUTH_PROFILE;
	...
	function authRegisterSuccess(message) {
	  return {
	    type: AUTH_REGISTER,
	    status: 'success',
	    message: message
	...
	function authRegisterFailure(error) {
	  return {
	    type: AUTH_REGISTER,
	    status: 'error',
	    error: error
	...
	function authLoginSuccess(profile) {
	  return {
	    type: AUTH_LOGIN,
	    status: 'success',
	    profile: profile
	...
	function authLoginFailure(status, error) {
	  return {
	    type: AUTH_LOGIN,
	    status: status,
	    error: error
	...
	function getProfile() {
	  return function (dispatch) {
	    return _apiAuth2['default'].getProfile().then(function (profile) {
	      return dispatch(authLoginSuccess(profile));
	    }).then(function () {
	      return dispatch((0, _subscriptions.getTokens)());
	    });
	  };
	}
	...
	function login(credentials) {
	  return function (dispatch) {
	    ...
	    return _apiAuth2['default'].login(credentials).then(function (profile) {
	      return dispatch(authLoginSuccess(profile));
	    }).then(function () {
	      return dispatch((0, _actionsEpisodesActions.getEpisodes)(10, 0, true));
	    })['catch'](function (status, error) {
	      return dispatch(authLoginFailure(status, error));
	    });
	  };
	}
	...
	function register(credentials) {
	  return function (dispatch) {
	    ...
	    return _apiAuth2['default'].register(credentials).then(function (message) {
	      return dispatch(authRegisterSuccess(message));
	    }).then(function () {
	      return dispatch(login(credentials));
	    })['catch'](function (error) {
	      return dispatch(authRegisterFailure(error));
	    });
	  };
	}
	...
	function logout() {
	  return function (dispatch) {
	    ...
	    return _apiAuth2['default'].logout().then(function (profile) {
	      return dispatch(authLoginSuccess(profile));
	    })['catch'](function (status, error) {
	      return dispatch(authLoginFailure(status, error));
	    }).then(function () {
	      return dispatch((0, _reduxRouter.pushState)(null, '/auth/login'));
	    }).then(function () {
	      return dispatch((0, _episodesActions.removeFavouriteEpisodesFromStore)());
	    });
	  };
	}
...
/***/ function(module, exports) {
	...
	authApi.login = function (credentials) {
	  return new Promise(function (resolve, reject) {
	...
	authApi.register = function (credentials) {
	  return new Promise(function (resolve, reject) {
	    var xmlhttp = new XMLHttpRequest();
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.addNewEpisode = addNewEpisode;
	exports.getGeneralEpisodesRequest = getGeneralEpisodesRequest;
	exports.getGeneralEpisodesSuccess = getGeneralEpisodesSuccess;
	exports.getGeneralEpisodesFailure = getGeneralEpisodesFailure;
	exports.getFavouriteEpisodesRequest = getFavouriteEpisodesRequest;
	exports.getFavouriteEpisodesSuccess = getFavouriteEpisodesSuccess;
	exports.getFavouriteEpisodesFailure = getFavouriteEpisodesFailure;
	exports.removeFavouriteEpisodesFromStore = removeFavouriteEpisodesFromStore;
	exports.getEpisodes = getEpisodes;
	
	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { 'default': obj }; }
	
	var _apiEpisodes = __webpack_require__(253);
	
	var _apiEpisodes2 = _interopRequireDefault(_apiEpisodes);
	
	var ADD_NEW_EPISODE = 'ADD_NEW_EPISODE';
	exports.ADD_NEW_EPISODE = ADD_NEW_EPISODE;
	var GET_GENERAL_EPISODES = 'GET_GENERAL_EPISODES';
	exports.GET_GENERAL_EPISODES = GET_GENERAL_EPISODES;
	var GET_FAVOURITE_EPISODES = 'GET_FAVOURITE_EPISODES';
	exports.GET_FAVOURITE_EPISODES = GET_FAVOURITE_EPISODES;
	var REMOVE_FAVOURITE_EPISODES = 'REMOVE_FAVOURITE_EPISODES';
	
	exports.REMOVE_FAVOURITE_EPISODES = REMOVE_FAVOURITE_EPISODES;
	
	function addNewEpisode(episode) {
	  return {
	...
	function getGeneralEpisodesRequest() {
	  return {
	...
	function getGeneralEpisodesSuccess(message) {
	  return {
	    type: GET_GENERAL_EPISODES,
	    status: 'success',
	    message: message
	...
	function getGeneralEpisodesFailure(error) {
	  return {
	    type: GET_GENERAL_EPISODES,
	    status: 'error',
	    error: error
	...
	function getFavouriteEpisodesRequest() {
	  return {
	    type: GET_FAVOURITE_EPISODES
	  };
	}
	
	function getFavouriteEpisodesSuccess(message) {
	  return {
	    type: GET_FAVOURITE_EPISODES,
	    status: 'success',
	    message: message
	...
	function getFavouriteEpisodesFailure(error) {
	  return {
	    type: GET_FAVOURITE_EPISODES,
	    status: 'error',
	    error: error
	...
	function removeFavouriteEpisodesFromStore() {
	  return {
	    type: REMOVE_FAVOURITE_EPISODES
	  };
	}
	
	function getEpisodes(numberOfEpisodes, fromEpisode, isSubscribed) {
	  return function (dispatch) {
	
	    if (isSubscribed) {
	      dispatch(getFavouriteEpisodesRequest());
	      _apiEpisodes2['default'].getEpisodes(numberOfEpisodes, fromEpisode, isSubscribed).then(function (episodes) {
	        return dispatch(getFavouriteEpisodesSuccess(episodes));
	      })['catch'](function (error) {
	        return dispatch(getFavouriteEpisodesFailure(error));
	      });
	    } else {
	      dispatch(getGeneralEpisodesRequest());
	      _apiEpisodes2['default'].getEpisodes(numberOfEpisodes, fromEpisode, isSubscribed).then(function (episodes) {
	        return dispatch(getGeneralEpisodesSuccess(episodes));
	      })['catch'](function (error) {
	        return dispatch(getGeneralEpisodesFailure(error));
	      });
	    }
	  };
	}
...
/***/ function(module, exports) {
	...
	episodesApi.getEpisodes = function (numberOfEpisodes, fromEpisode, isSubscribed) {
	  return new Promise(function (resolve, reject) {
	    ...
	    xmlhttp.send(JSON.stringify({ numberOfEpisodes: numberOfEpisodes, fromEpisode: fromEpisode, isSubscribed: isSubscribed }));
	    console.log(JSON.stringify({ numberOfEpisodes: numberOfEpisodes, fromEpisode: fromEpisode, isSubscribed: isSubscribed }));
	  });
	};
	
	exports['default'] = episodesApi;
	module.exports = exports['default'];
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.fetchTokensRequest = fetchTokensRequest;
	exports.fetchTokensSuccess = fetchTokensSuccess;
	exports.fetchTokensFailure = fetchTokensFailure;
	exports.subscribeRequest = subscribeRequest;
	exports.subscribeRequestSuccess = subscribeRequestSuccess;
	exports.subscribeRequestFailure = subscribeRequestFailure;
	exports.unsubscribeRequest = unsubscribeRequest;
	exports.unsubscribeSuccess = unsubscribeSuccess;
	exports.unsubscribeFailure = unsubscribeFailure;
	...
	var FETCH_TOKENS = 'FETCH_TOKENS';
	exports.FETCH_TOKENS = FETCH_TOKENS;
	...
	function fetchTokensSuccess(data) {
	  return {
	    type: FETCH_TOKENS,
	    status: 'success',
	    data: data
	...
	function fetchTokensFailure(message) {
	  return {
	    type: FETCH_TOKENS,
	    status: 'error',
	    message: message
	...
	function subscribeRequest(tokenId) {
	  return {
	    type: SUBSCRIBE,
	    tokenId: tokenId
	  };
	...
	function subscribeRequestSuccess(data) {
	  return {
	    type: SUBSCRIBE,
	    status: 'success'
	  };
	...
	function subscribeRequestFailure(error) {
	  return {
	    type: SUBSCRIBE,
	    status: 'error',
	    error: error
	...
	function unsubscribeRequest(tokenId) {
	  return {
	    type: UNSUBSCRIBE,
	    tokenId: tokenId
	  };
	...
	function getTokens() {
	  return function (dispatch) {
	    ...
	    Promise.all([(0, _api.getTokens)(), (0, _api.getSubscriptions)()]).then(function (data) {
	      var _data = _slicedToArray(data, 2);
	
	      var tokens = _data[0];
	      var subscriptions = _data[1];
	
	      return tokens.map(function (token) {
	        return _extends({}, token, {
	          subscribed: subscriptions.find(function (subscription) {
	            return subscription.token.id === token.id;
	          }) ? true : false
	        });
	      });
	    }).then(function (tokens) {
	      return dispatch(fetchTokensSuccess(tokens));
	    })['catch'](function (error) {
	      return dispatch(fetchTokensFailure(error));
	    });
	  };
	}
	...
	function subscribe(tokenId) {
	  return function (dispatch) {
	    ...
	    return (0, _api.addSubscription)({ id: tokenId }).then(function () {
	      return dispatch(subscribeRequestSuccess());
	    }).then(function () {
	      return dispatch((0, _episodesActions.removeFavouriteEpisodesFromStore)());
	    }).then(function () {
	      return dispatch((0, _episodesActions.getEpisodes)(10, 0, true));
	    })['catch'](function (error) {
	      return dispatch(subscribeRequestFailure(error));
	    });
	  };
	}
	...
	function unsubscribe(tokenId) {
	  return function (dispatch) {
	    ...
	    return (0, _api.removeSubscription)({ id: tokenId }).then(function () {
	      return dispatch(unsubscribeSuccess());
	    }).then(function () {
	      return dispatch((0, _episodesActions.removeFavouriteEpisodesFromStore)());
	    }).then(function () {
	      return dispatch((0, _episodesActions.getEpisodes)(10, 0, true));
	    })['catch'](function (error) {
	      return dispatch(unsubscribeFailure(error));
	    });
	  };
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _subscriptions = __webpack_require__(256);
	
	Object.defineProperty(exports, 'getTokens', {
	  enumerable: true,
	  get: function get() {
	    return _subscriptions.getTokens;
	  }
	});
	...
	Object.defineProperty(exports, 'addSubscription', {
	  enumerable: true,
	  get: function get() {
	    return _subscriptions.addSubscription;
	  }
	});
	Object.defineProperty(exports, 'removeSubscription', {
	  enumerable: true,
	  get: function get() {
	    return _subscriptions.removeSubscription;
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	function getTokens() {
	  return (0, _request2['default'])('getTokens');
	}
	
	function getSubscriptions() {
	  return (0, _request2['default'])('getSubscriptions');
	}
	
	function addSubscription(data) {
	  return (0, _request2['default'])('addSubscriptionByTokenId', data);
	}
	
	function removeSubscription(data) {
	  return (0, _request2['default'])('removeSubscriptionById', data);
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	function episodes(state, action) {
	  ...
	  var message = action.message;
	  var error = action.error;
	  var episode = action.episode;
	
	  switch (type) {
	    case _actionsEpisodesActions.ADD_NEW_EPISODE:
	      if ((0, _utils.checkSubscriptionByTokenId)(episode.token.id)) {
	        return _extends({}, state, { generalEpisodes: [episode].concat(_toConsumableArray(state.generalEpisodes)), favouriteEpisodes: [episode].concat(_toConsumableArray(state.favouriteEpisodes)) });
	      } else {
	        return _extends({}, state, { generalEpisodes: [episode].concat(_toConsumableArray(state.generalEpisodes)) });
	      }
	
	    case _actionsEpisodesActions.GET_GENERAL_EPISODES:
	      if (!status) {
	        return _extends({}, state, { isLoading: true });
	      }
	
	      if (status === 'success') {
	        return _extends({}, state, { generalEpisodes: [].concat(_toConsumableArray(state.generalEpisodes), _toConsumableArray(message)), isLoading: false });
	      } else {
	        return _extends({}, state, { error: error, isLoading: false });
	      }
	
	    case _actionsEpisodesActions.GET_FAVOURITE_EPISODES:
	      if (!status) {
	        return _extends({}, state, { isLoading: true });
	      }
	
	      if (status === 'success') {
	        return _extends({}, state, { favouriteEpisodes: [].concat(_toConsumableArray(state.favouriteEpisodes), _toConsumableArray(message)), isLoading: false });
	      } else {
	        return _extends({}, state, { error: error, isLoading: false });
	      }
	
	    case _actionsEpisodesActions.REMOVE_FAVOURITE_EPISODES:
	      return _extends({}, state, { favouriteEpisodes: [] });
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.checkSubscriptionByTokenId = checkSubscriptionByTokenId;
	...
	function requireLogin(nextState, replaceState) {
	  if (!_store2['default'].getState().auth.profile) {
	    replaceState({
	...
	function checkSubscriptionByTokenId(tokenId) {
	  return _store2['default'].getState().subscriptions.tokens.find(function (token) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	function subscriptions(state, action) {
	  ...
	  var error = action.error;
	  var tokenId = action.tokenId;
	
	  switch (type) {
	    case _actionsSubscriptions.FETCH_TOKENS:
	      if (!status) {
	        return _extends({}, state, { isLoading: true });
	      }
	      ...
	      if (status === 'error') {
	        return _extends({}, state, { error: error, isLoading: false, numberOfInvalid: 0 });
	      }
	
	    case _actionsSubscriptions.SUBSCRIBE:
	      if (!status) {
	        // it's hack
	        state.tokens.find(function (token) {
	          return token.id === tokenId;
	        }).subscribed = true;
	        return _extends({}, state, { numberOfInvalid: state.numberOfInvalid + 1 });
	      }
	    ...
	    case _actionsSubscriptions.UNSUBSCRIBE:
	      if (!status) {
	        // it's hack
	        state.tokens.find(function (token) {
	          return token.id === tokenId;
...
/***/ function(module, exports) {
	...
	var SET_PATTERN = 'SET_PATTERN';
	
	exports.SET_PATTERN = SET_PATTERN;
	...
	function createWebSocket() {
	  return function (dispatch) {
	    ...
	    socket.onmessage = function (event) {
	      ...
	      dispatch((0, _actionsEpisodesActions.addNewEpisode)(JSON.parse(event.data)));
	    };
